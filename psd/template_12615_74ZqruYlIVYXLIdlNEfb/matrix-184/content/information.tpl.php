...
?>
      ...
      <tr>
        <td><br><br style="line-height:10px"><table border="0" width="100%" cellspacing="0" cellpadding="0">
<?php
// BOF: Lango Added for template MOD
if (MAIN_TABLE_BORDER == 'yes'){
$INFO_TITLE = $INFO_TITLE;
table_image_border_top(false, false, $INFO_TITLE);
}
// EOF: Lango Added for template MOD
?>
<?php
...
?>
          <tr>
            <td class="main" style="padding-left: 5px"><?php echo $INFO_DESCRIPTION; ?></td>
          </tr>
<?php
// BOF: Lango Added for template MOD
if (MAIN_TABLE_BORDER == 'yes'){
