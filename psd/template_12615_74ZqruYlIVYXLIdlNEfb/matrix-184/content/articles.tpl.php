...
/* eof catdesc for bts1a */ ?></td>
        ...
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
          ...
          <tr>
            <td align="left" colspan="2" class="main" style="padding-left: 10px; padding-right: 10px;"><?php echo $topic['topics_description']; ?></td>
          </tr>
                <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td style="padding-left: 5px; padding-right: 5px;"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
<?php
...
?>
          ...
          <tr>
            <td style="padding-left: 5px; padding-right: 5px;"><?php /*include(DIR_WS_MODULES . FILENAME_NEW_ARTICLES); */ ?></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
...
?>
      <tr>
        <td style="padding-left: 5px; padding-right: 5px;"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td style="padding-left: 5px; padding-right: 5px;" class="pageHeading" valign="top"><?php echo $_heading_title; ?></td>
            <td style="padding-left: 5px; padding-right: 5px;" class="pageHeading" align="right" valign="top"><?php echo $_author_name; ?></td>
          </tr>
        </table></td>
      </tr>
<?php
...
?>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
           <td valign="top" align="left" class="pageHeading" style="padding:0 10 0 10px">
...
// optional Article List Filter
    if (ARTICLE_LIST_FILTER) {
      ...
      if (tep_db_num_rows($filterlist_query) > 1) {
        echo '<td align="right" class="main" style="padding-left: 5px; padding-right: 5px;"><!-- ' . tep_draw_form('filter', FILENAME_ARTICLES, 'get') . TEXT_SHOW . '&nbsp;';
        if (isset($HTTP_GET_VARS['authors_id'])) {
...
?>
         ...
         <?php if ( tep_not_null($topic['topics_description']) ) { ?>                                                                   
       <tr>
          <td align="left" colspan="2" style="padding-left: 5px; padding-right: 5px;" class="main"><?php echo $topic['topics_description']; ?></td>
       </tr>
       <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
       </tr>
...
<?php if (tep_not_null($authors_description)) { ?>
          ...
          <tr>
            <td style="padding-left: 5px; padding-right: 5px;" class="main" colspan="2" valign="top"><?php echo $authors_description; ?></td>
          <tr>
          <?php } ?>
<?php if (tep_not_null($authors_url)) { ?>
          ...
          <tr>
            <td class="main" colspan="2" valign="top" style="padding-left: 5px; padding-right: 5px;"><?php echo sprintf(TEXT_MORE_INFORMATION, $authors_url); ?></td>
          <tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
...
?>
<tr>
        <td style="padding-left: 10px; padding-right: 10px;" height="10"></td>
      </tr>
    </table>
</td>
<?php
...
?>
      <tr>
        <td style="padding-left: 5px; padding-right: 5px;"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading" style="padding-left: 5px; padding-right: 5px;"><?php echo HEADING_TITLE; ?></td>
...
?>
      <tr>
        <td style="padding-left: 5px; padding-right: 5px;"><?php include(DIR_WS_MODULES . FILENAME_ARTICLES_UPCOMING); ?></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
...
?>
      <tr>
        <td class="pageHeading" style="padding-left: 5px; padding-right: 5px;"><?php echo '<b>' . TEXT_CURRENT_ARTICLES . '</b>'; ?></td>
      </tr>
      <!-- tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr -->
...
?>
      <!-- tr>
        <td class="main" style="padding-left: 5px; padding-right: 5px;"><?php echo TEXT_ALL_ARTICLES; ?></td>
      </tr -->
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
...
?>
          <tr>
            <td valign="top" class="main" width="75%" style="padding-left: 5px; padding-right: 5px;">
<?php
...
?>
            <td valign="top" class="main" width="25%" nowrap style="padding-left: 5px; padding-right: 5px;"><?php echo TEXT_TOPIC . '&nbsp;<a href="' . tep_href_link(FILENAME_ARTICLES, 'tPath=' . $articles_all['topics_id']) . '">' . $articles_all['topics_name'] . '</a>'; ?></td>
<?php
      }
?>
          </tr>
...
?>
          <tr>
            <td class="main" style="padding-left: 5px; padding-right: 5px;"><?php echo TEXT_NO_ARTICLES; ?></td>
          </tr>
          <tr>
            <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
          </tr>
