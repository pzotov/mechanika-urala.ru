...
?>
	<tr>
		<td width="100%" class="main" valign="top" colspan="3">
<table border="0" width="100%" cellspacing="0" cellpadding="3">
	<tr class="headerNavigation">
		<td class="tableHeading" style="padding-left: 5px"><?php echo $product_info_values['newsdesk_article_name']; ?></td>
		<td class="subBar" align="right" style="padding-right: 3px">&nbsp;
	...
	<tr>
 	<td width="100%" class="main" valign="top" style="padding-left: 5px; padding-right: 5px;">
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" style="padding-left: 5px; padding-right: 5px;">
	<tr>
