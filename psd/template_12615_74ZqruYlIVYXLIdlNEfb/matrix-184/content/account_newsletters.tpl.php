    <?php echo tep_draw_form('account_newsletter', tep_href_link(FILENAME_ACCOUNT_NEWSLETTERS, '', 'SSL')) . tep_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="<?php echo CELLPADDING_SUB; ?>" class="bg0">
<?php
...
?>
      <tr>
        <td class="main" style="padding-left: 7px"><b><?php echo MY_NEWSLETTERS_TITLE; ?></b></td>
      </tr>
      <tr>
