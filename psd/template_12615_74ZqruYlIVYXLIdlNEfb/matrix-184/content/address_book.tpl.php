...
?>
      <tr>
        <td class="main" style="padding-left: 7px"><b><?php echo PRIMARY_ADDRESS_TITLE; ?></b></td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="main" style="padding-left: 7px"><b><?php echo ADDRESS_BOOK_TITLE; ?></b></td>
      </tr>
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
...
?>
      ...
      <tr>
        <td class="smallText" style="padding-left: 7px"><?php echo sprintf(TEXT_MAXIMUM_ENTRIES, MAX_ADDRESS_BOOK_ENTRIES); ?></td>
      </tr>
    </table>
