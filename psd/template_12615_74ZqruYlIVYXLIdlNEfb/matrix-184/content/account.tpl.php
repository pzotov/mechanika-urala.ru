...
?>
      <tr>
        <td><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main" style="padding-left: 8px"><b><?php echo OVERVIEW_TITLE; ?></b></td>
        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="80%" cellspacing="0" cellpadding="2">
              <tr>
                <td align="center" valign="top" width="115"><?php echo '<b>' . OVERVIEW_PREVIOUS_ORDERS . '</b><br>' . tep_image(DIR_WS_IMAGES . 'arrow_south_east.gif'); ?></td>
...
?>
                  <tr class="moduleRow" onMouseOver="rowOverEffect(this)" onMouseOut="rowOutEffect(this)" onClick="document.location.href='<?php echo tep_href_link(FILENAME_ACCOUNT_HISTORY_INFO, 'order_id=' . $orders['orders_id'], 'SSL'); ?>'">
                    <td class="main2"><?php echo tep_date_short($orders['date_purchased']); ?></td>
                    <td class="main2"><?php echo '#' . $orders['orders_id']; ?></td>
                    <td class="main2"><?php echo tep_output_string_protected($order_name) . ', ' . $order_country; ?></td>
                    <td class="main2"><?php echo $orders['orders_status_name']; ?></td>
                    <td class="main2" align="right"><?php echo $orders['order_total']; ?><br>
...
?>
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td style="padding-left: 8px" class="main"><b><?php echo MY_ACCOUNT_TITLE; ?></b></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td class="bg0"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td style="padding-left: 8px" class="main"><b><?php echo MY_ORDERS_TITLE; ?></b></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td style="padding-left: 8px" class="main"><b><?php echo EMAIL_NOTIFICATIONS_TITLE; ?></b></td>
          </tr>
        </table></td>
      </tr>
      <tr>
