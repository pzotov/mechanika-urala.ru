...
<tr>
		<td class="main" style="padding-left: 5px"><b><?php echo SUB_TITLE_REVIEW; ?></b></td>
	</tr>
	<tr>
		<td style="padding-left: 5px; padding-right: 5px;"><?php echo tep_draw_textarea_field('review', 'soft', 60, 15);?></td>
	</tr>
	<tr>
